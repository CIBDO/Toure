...
export const useLayoutConfigStore = defineStore('layoutConfig', () => {
  ...
  // 👉 App Content Layout Nav — verrouillé en Vertical (ignore le cookie)
  const appContentLayoutNav = ref<typeof AppContentLayoutNav[keyof typeof AppContentLayoutNav]>(AppContentLayoutNav.Vertical)
