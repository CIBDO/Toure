...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'apps-contrats': RouteRecordInfo<'apps-contrats', '/apps/contrats', Record<never, never>, Record<never, never>>,
    'apps-contrats-id': RouteRecordInfo<'apps-contrats-id', '/apps/contrats/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apps-contrats-avenants': RouteRecordInfo<'apps-contrats-avenants', '/apps/contrats/avenants', Record<never, never>, Record<never, never>>,
    'apps-contrats-avenants-id': RouteRecordInfo<'apps-contrats-avenants-id', '/apps/contrats/avenants/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apps-contrats-ordre-services': RouteRecordInfo<'apps-contrats-ordre-services', '/apps/contrats/ordre-services', Record<never, never>, Record<never, never>>,
    'apps-contrats-ordre-services-id': RouteRecordInfo<'apps-contrats-ordre-services-id', '/apps/contrats/ordre-services/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apps-contrats-receptions': RouteRecordInfo<'apps-contrats-receptions', '/apps/contrats/receptions', Record<never, never>, Record<never, never>>,
    'apps-contrats-receptions-id': RouteRecordInfo<'apps-contrats-receptions-id', '/apps/contrats/receptions/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apps-documents-ged': RouteRecordInfo<'apps-documents-ged', '/apps/documents/ged', Record<never, never>, Record<never, never>>,
    ...
    'apps-finances-engagements': RouteRecordInfo<'apps-finances-engagements', '/apps/finances/engagements', Record<never, never>, Record<never, never>>,
    'apps-finances-paiements': RouteRecordInfo<'apps-finances-paiements', '/apps/finances/paiements', Record<never, never>, Record<never, never>>,
    ...
    'apps-passation-avis': RouteRecordInfo<'apps-passation-avis', '/apps/passation/avis', Record<never, never>, Record<never, never>>,
    'apps-passation-depouillements': RouteRecordInfo<'apps-passation-depouillements', '/apps/passation/depouillements', Record<never, never>, Record<never, never>>,
    'apps-passation-pvs': RouteRecordInfo<'apps-passation-pvs', '/apps/passation/pvs', Record<never, never>, Record<never, never>>,
    'apps-permissions': RouteRecordInfo<'apps-permissions', '/apps/permissions', Record<never, never>, Record<never, never>>,
    'apps-rapports-contrats': RouteRecordInfo<'apps-rapports-contrats', '/apps/rapports/contrats', Record<never, never>, Record<never, never>>,
    'apps-rapports-engagements': RouteRecordInfo<'apps-rapports-engagements', '/apps/rapports/engagements', Record<never, never>, Record<never, never>>,
    'apps-rapports-financial': RouteRecordInfo<'apps-rapports-financial', '/apps/rapports/financial', Record<never, never>, Record<never, never>>,
    'apps-rapports-payments': RouteRecordInfo<'apps-rapports-payments', '/apps/rapports/payments', Record<never, never>, Record<never, never>>,
    'apps-rapports-suppliers': RouteRecordInfo<'apps-rapports-suppliers', '/apps/rapports/suppliers', Record<never, never>, Record<never, never>>,
    ...
    'apps-user-view-user-view-by-id': RouteRecordInfo<'apps-user-view-user-view-by-id', '/apps/user/view/user-view-by-id', Record<never, never>, Record<never, never>>,
    ...
    'dashboards-canam': RouteRecordInfo<'dashboards-canam', '/dashboards/canam', Record<never, never>, Record<never, never>>,
